...
const TEST_PROMPT = [
  ...
  "",
  "IMPORTANT: Read the architecture doc's ## File Structure section BEFORE writing any files.",
  "Create test files at the paths specified there — NOT in a default `tests/` folder.",
  "The architecture doc is the single source of truth for where files go.",
  "",
  "Your job:",
  "1. Read the architecture doc for file paths and integration patterns",
  "2. Write failing tests (RED state) for each user story",
...
const IMPL_PROMPT = [
  ...
  "",
  "## Context files (READ THESE FIRST)",
  "- Stories: `{storiesPath}` — read for intent and acceptance criteria",
  "- Architecture doc: `{archPath}` — read for integration patterns, dependencies, and FILE PATHS",
  "",
  "IMPORTANT: Read the architecture doc's ## File Structure section BEFORE writing any files.",
  ...
  "2. **User stories** — for intent and acceptance criteria",
  "3. **Architecture doc** — for HOW to build it (libraries, patterns, file paths)",
  "",
  "Your job:",
