...
const BRAINSTORM_PROMPT = [
  ...
  "- Use Read, Grep, Glob to research the codebase for existing patterns and prior art.",
  ...
  "- For each: what it optimizes for, what it costs, who's done it before.",
  ...
  "- Use Write to create user stories at tests/stories/{slug}.md",
  "- Each story needs: unique ID (STORY-001), description, acceptance criteria checklist, edge cases.",
  "- Use AskUserQuestion: 'Here are N stories. Ready to start the pipeline?'",
  "",
  "### Phase 4: Ship it",
  "- Use Bash to run: hog pipeline create \"{title}\" --brainstorm-done --stories tests/stories/{slug}.md",
  "- This kicks off autonomous work: stories → tests → impl → redteam → merge",
  "",
  "## Rules",
  "- Use AskUserQuestion for every decision point — don't just dump text.",
